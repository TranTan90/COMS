...
public partial class main_security_carVisitDataList : System.Web.UI.Page
{
    ...
    protected void btnInput_Click(object sender, EventArgs e)
    {
      ...
      //      carData.CompanyCode = Convert.ToInt32(Request.Form["companyName"]);
            ...
            if (!bll.existsCarData(carData.Header, carData.Number, carData.CompanyCode))
            {
                ...
                {
                    carData.CarCategoryCode = 55;
                }
                else carData.CarCategoryCode = 52; //그외 입출문 관리에서 등록할 경우 납품차로 고정(트럭:code 17)  / Ngoài ra Trong quản lý xe ra vào cổng, trường hợp chưa đăng ký thì cố định bằng xe giao hàng
