...
namespace HanaMicron.COMS.Model
{
    ...
    public class CompanyInfo
    {
        ...
        public CompanyInfo(
            int companyCode, String companyName, String regNumber1, String regNumber2, String regNumber3, String regNumber4,
        ...
        public String RegNumber4
        {
            get { return this.regNumber4; }
            set { this.regNumber4 = value; }
        }
        ...
        public String ToString()
        {
            ...
            str.Append("regNumber4 : " + regNumber4 + "\n");
		...
		//	str.Append("employeeName : " + employeeName + "\n");
            ...
            str.Append("employeedept : " + employeeDept + "\n");
