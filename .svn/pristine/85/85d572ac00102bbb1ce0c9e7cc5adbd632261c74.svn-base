    ...
    <table style="width: 100%; height: 100%;" id="TABLE1">
        <tr>
            <td align="left" valign="top" style="height: 24px; width: 1020px;">
                <table style="width: 800px" id="TABLE2">
                    <tr>
                        <td style="width: 192px; height: 27px; width: 1220px;">
                            Khách thăm đã đăng ký (등록된 내방객 수):
                            <asp:Label ID="Label1" runat="server"></asp:Label>
                            Người (명)</td>
                        <td align="right" style="height: 27px;width: 1020px;">
                            ...
                            <asp:DropDownList ID="keyWord" runat="server">
                                <asp:ListItem Value="visitorName">Tên khách thăm (내방객 이름)</asp:ListItem>
                                <%--2021-05-04 반안: 주민번호는 빼고 “생년월일” 을 추가함 (박민수 차장 요청)--%>
                            ...
                            <asp:TextBox ID="key" runat="server" CssClass="input1" Width="100px" style="ime-mode:active"></asp:TextBox>

                          <%--  <asp:ImageButton ID="btnSearch" runat="server" ImageUrl="~/images/icon/btn_search.gif" ImageAlign="AbsMiddle" ValidationGroup="AllValidators" />
                            --%>
                            <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/icon/btn_search.gif" ImageAlign="AbsMiddle" ValidationGroup="AllValidators" />
