...
$(function () {
    ...
    var imgmodal = $('.modal-content');
    img.on('click', function () {
        modal1.style.display = 'block';
        var newsrc = this.src;
        imgmodal.attr('src', newsrc);
    });
...
<tr>
	...
	<table width="100%"  style="background-color:#CCCCCC"  class="table table-bordered">
		...
		<tr>
			<td style="background-color:#F5F5F5;" width="200">
    ...
    <td>
    <a >
      <asp:Image ID="viewimage1" runat="server"  Height="250px" Width="250px"  data-lightense-padding="400" class="img1" />
   ...
   <a data-fancybox="gallery"  >
       <asp:Image ID="viewimage2" runat="server"  Height="250px" Width="250px" data-lightense-padding="400" class="img1" />
    ...
    <td>
    <a data-fancybox="gallery" >
     <asp:Image ID="viewimage3" runat="server"  Height="250px" Width="250px" data-lightense-padding="400"  class="img1"  />
	...
	<img   alt ="" class="modal-content" id="modalImg">
</div>
	</div>
