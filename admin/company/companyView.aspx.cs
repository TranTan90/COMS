...
public partial class admin_car_carCategoryView : System.Web.UI.Page
{
	...
	protected void DetailsView1_DataBound(object sender, EventArgs e)
	{
        ...
        DetailsView1.Rows[6].Cells[1].Text = companyInfo.RegNumber1 + " - " + companyInfo.RegNumber2 + " - " + companyInfo.RegNumber3 + " - " + companyInfo.RegNumber4;

		DetailsView1.Rows[16].Cells[1].Attributes.Add("align", "center");
		DetailsView1.Rows[16].Cells[0].Visible = false;
		DetailsView1.Rows[16].Cells[1].ColumnSpan = 2;

		HyperLink colCancel = (HyperLink)DetailsView1.Rows[16].Cells[1].Controls[0];
